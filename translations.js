const translations = {
      it: {
          ...
          homepage_title: "FOREX Dashboard",
                    ...
                    search_placeholder: "Cerca divisa (es. CAD, Dollaro...)",
                    search_add: "Cerca e aggiungi divisa...",
                    offline_mode: "Modalita Offline (Tassi indicativi)",
                    ...
                    group_brl: "Cambi verso BRL",
                    page_title_historical: "Cambi Storici",
                    ...
                    loader_sync_footer: "Questa operazione richiedera pochi secondi la prima volta.",
                    ...
                    db_title: "Database Giornaliero Completo",
                    ...
                    yellow_rows_only: "Solo Righe Gialle (Fine Mese)",
                    col_date: "Data",
                    ...
                    error_connection_text: "Impossibile recuperare i dati dalla Banca Centrale Europea al momento. Controlla la tua connessione o riprova pu tardi.",
                    mese_prefix: "Mese: ",
    ...
    fr: {
              homepage_title: "FOREX Dashboard",
                        ...
                        nav_database: "Base de Donnee Historique",
                        group_main: "Taux Principaux",
                        group_brl: "Taux vers BRL",
                        page_title_historical: "Taux Historiques",
                        subtitle_historical: "Analyse Historique",
                        ...
                        loader_sync_title: "Synchronisation des Donnees Historiques",
                        loader_sync_text: "Telechargement des series historiques des taux de change (de 2010 a aujourd'hui) depuis la Banque Centrale Europeenne...",
                        loader_sync_footer: "Cette operation prendra quelques secondes la premiere fois.",
                        last_change: "Dernier Taux",
                        from_yesterday: "depuis hier",
                        from_prev: "depuis prec.",
                        ...
                        range_3m: "3M",
                        range_1m: "1M",
                        monthly_table_title: "Clotures Mensuelles Historiques",
                        col_month_year: "Mois/Annee",
                        col_last_day: "Dernier Jour",
                        col_closing_rate: "Taux de Cloture",
                        col_monthly_avg: "Moyenne Mensuelle",
                        db_title: "Base de Donnees Quotidienne Complete",
                        export_excel: "Exporter vers Excel",
                        period_label: "Periode (Mois/Annee)",
                        all_periods: "Toutes les periodes",
                        closing_only_label: "Clotures Mensuelles Uniquement",
                        show_all: "Afficher tout",
                        yellow_rows_only: "Lignes Jaunes Uniquement (Fin de mois)",
                        col_date: "Date",
                        col_day_closing: "Valeur de Cloture du Jour (Taux)",
                        col_month_closing: "Cloture du Mois",
                        col_source: "Source des Donnees",
                        yes: "Oui",
                        no: "Non",
                        api_live: "API Live",
                        historical: "Historique",
                        reset_confirm: "Voulez-vous davvero effacer la memoire locale pour {pair} et tout retelecharger depuis l'API?",
                        no_data_export: "Aucune donnee a exporter.",
                        syncing_year: "Sync. annee {year}...",
                        period_avg: "Moyenne Periode",
                        error_connection_title: "Erreur de Connexion",
                        error_connection_text: "Impossible de recuperer les donnees de la Banque Centrale Europeenne pour le moment. Veuillez verifier votre connexion ou reessayer plus tard.",
                        mese_prefix: "Mois: ",
                        sidebar_logo_dash: "Dash"
    }
};
