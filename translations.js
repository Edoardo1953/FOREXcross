...
const translations = {
    it: {
        ...
        yellow_rows_only: "Solo Fine Mese (Righe Blu)",
        col_date: "Data",
        ...
        mese_prefix: "Mese: ",
        show_all_history: "Mostra tutto lo storico ({count} righe)",
        ...
        manual_advanced_title: "Manuale d'Uso Avanzato v2.5",
        ...
        manual_install_title: "Installazione App su PC, Tablet e Mobile",
    ...
    en: {
        ...
        group_forex: "Foreign Currencies",
        db_title: "Database",
        subtitle_database: "Database",
        ...
        show_all: "Show all",
        yellow_rows_only: "Month End (Blue Rows)",
        col_date: "Date",
        ...
        mese_prefix: "Month: ",
        show_all_history: "Show all history ({count} rows)",
        sidebar_logo_dash: "Dash",
        ...
        manual_advanced_title: "Advanced User Manual v2.5",
        dev_preview_label: "Developer Access",
        ...
        manual_install_title: "How to install the App on PC, Tablet and Mobile",
    ...
    fr: {
        ...
        group_forex: "Devises Étrangères",
        db_title: "Database",
        subtitle_database: "Database",
        ...
        yellow_rows_only: "Fin de Mois (Lignes Bleues)",
        col_date: "Date",
        ...
        mese_prefix: "Mois: ",
        show_all_history: "Afficher tout l'historique ({count} lignes)",
        sidebar_logo_dash: "Dash",
        ...
        // Share Access
        share_access_title: "Partager l'accès",
        share_access_desc: "Créez un lien protégé par mot de passe pour donner un accès temporaire.",
        access_password_label: "Mot de passe d'accès",
        access_expiry_label: "Durée de l'accès",
        access_1month: "1 Mois",
        access_3months: "3 Mois",
        access_6months: "6 Mois",
        access_1year: "1 An",
        btn_generate_link: "Générer le lien",
        copy_link: "Copier le lien",
        link_generated: "Lien copié dans le presse-papiers !",
        prompt_password_title: "Accès Protégé",
        prompt_password_desc: "Saisissez le mot de passe fourni pour accéder au tableau de bord.",
        ...
        manual_advanced_title: "Manuel d'Utilisation Avancé v2.5",
        ...
        manual_install_title: "Installation de l'App sur PC, Tablet et Mobile",
        admin_section_title: "Configuration",
